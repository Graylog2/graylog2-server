...
var SearchResult = React.createClass({
    ...
    _toggleMessageDetail(id) {
        ...
        this.setState(this.state.expandedMessages);
    },
    ...
    render() {
        ...
        return (<div className="content-col">
            ...
            <table className="table table-condensed messages">
                ...
                { this.props.result.messages.map((message) => <MessageTableEntry key={message.id} message={message} expanded={this.state.expandedMessages[message.id]} toggleDetail={this._toggleMessageDetail} />) }
            </table>
