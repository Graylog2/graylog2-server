...
public class TimeRangeFilterQueryTest {
    @Rule
    ...
    public void getTimestampRangeFilterReturnsNullIfTimeRangeIsNull() {
        Assertions.assertThat(TimeRangeFilterQuery.create(null)).isNull();
    }
    ...
    public void getTimestampRangeFilterReturnsRangeQueryWithGivenTimeRange() {
        ...
        final RangeQueryBuilder queryBuilder = (RangeQueryBuilder) TimeRangeFilterQuery.create(timeRange);
