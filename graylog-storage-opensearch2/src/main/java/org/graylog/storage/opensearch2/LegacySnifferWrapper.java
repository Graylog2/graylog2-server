...
public class LegacySnifferWrapper implements org.graylog.shaded.opensearch2.org.opensearch.client.sniff.NodesSniffer {
    private final List<LegacyNodesSniffer> sniffers = new CopyOnWriteArrayList<>();
    ...
    private LegacySnifferWrapper(RestClient restClient, long sniffRequestTimeoutMillis, Duration discoveryFrequency, OpenSearchNodesSniffer.Scheme scheme) {
    ...
    public List<Node> sniff() throws IOException {
        ...
        for (LegacyNodesSniffer sniffer : sniffers) {
            nodes = sniffer.sniff(nodes);
        }
        return nodes;
    }

    public static LegacySnifferWrapper create(RestClient restClient, long sniffRequestTimeoutMillis, Duration discoveryFrequency, OpenSearchNodesSniffer.Scheme scheme) {
        return new LegacySnifferWrapper(restClient, sniffRequestTimeoutMillis, discoveryFrequency, scheme);
    }
    ...
    public void add(LegacyNodesSniffer sniffer) {
