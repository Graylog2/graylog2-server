...
public class RadioAMQPInput2 extends AMQPInput2 {

    @AssistedInject
    public RadioAMQPInput2(@Assisted Configuration configuration,
    ...
    public String getName() {
        return "Graylog2 Radio Input (AMQP) (transport)";
    }

    public interface Factory extends MessageInput2.Factory<RadioAMQPInput2> {
        @Override
        RadioAMQPInput2 create(Configuration configuration);

        @Override
        RadioAMQPInput2 create(Configuration configuration, Transport transport, Codec codec);
    }
}
