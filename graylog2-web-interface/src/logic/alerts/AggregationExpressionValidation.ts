...
const flattenValidationTree = (validationTree: ValidationNode, errors: Array<string> = []): Array<string> => {
...
const validateExpression = (expression: Expression | undefined | null, series: Array<Series>): ValidationResult => {
  const validationResults: ValidationResult = { isValid: false };
