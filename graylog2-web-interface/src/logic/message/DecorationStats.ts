 ...
 */
type DecorationStatsData = {
  added_fields?: Record<string, unknown>;
  changed_fields?: Record<string, unknown>;
};

type MessageWithDecorationStats = {
  decoration_stats?: DecorationStatsData;
};

const DecorationStats = {
  isFieldAddedByDecorator(message: MessageWithDecorationStats, fieldName: string): boolean {
