...
export const TELEMETRY_EVENT_TYPE = {
  ...
  EVENTDEFINITION_TAG_ADDED: 'EventDefinition Tag Added',
  EVENTDEFINITION_TAG_UPDATED: 'EventDefinition Tag Updated',
  EVENTDEFINITION_TAG_DELETED: 'EventDefinition Tag Deleted',
