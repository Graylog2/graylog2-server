...
export const TELEMETRY_EVENT_TYPE = {
  ...
  SEARCH_FIELD_VALUE_ACTION: {
    ...
    REMOVE_CUSTOM_FIELD_TYPE_OPENED: 'Search Field Action Remove Custom Field Type Opened',
    REMOVE_CUSTOM_FIELD_TYPE_CLOSED: 'Search Field Action Remove Custom Field Type Closed',
    REMOVE_CUSTOM_FIELD_TYPE_REMOVED: 'Search Field Action Remove Custom Field Type Removed',
  },
