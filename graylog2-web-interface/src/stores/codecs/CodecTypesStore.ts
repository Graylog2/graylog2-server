...
type CodecTypesActionsType = {
  list: () => Promise<unknown>;
};

export const CodecTypesActions = singletonActions('core.CodecTypes', () =>
  Reflux.createActions<CodecTypesActionsType>({
    list: { asyncResult: true },
  }),
);

export const CodecTypesStore: Store<{ codecTypes: unknown }> = singletonStore('core.CodecTypes', () =>
  Reflux.createStore({
