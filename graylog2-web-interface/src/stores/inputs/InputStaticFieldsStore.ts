...
export const InputStaticFieldsStore = singletonStore('core.InputStaticFields', () =>
  Reflux.createStore({
    listenables: [],
    sourceUrl: (inputId: string) => `/system/inputs/${inputId}/staticfields`,

    create(input: { id: string; title: string }, name: string, value: string) {
    ...
    destroy(input: { id: string; title: string }, name: string) {
