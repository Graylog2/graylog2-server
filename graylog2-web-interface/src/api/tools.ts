...
export type NaturalDateResponse = {
  from: string;
  to: string;
  timezone: string;
};

export const testNaturalDate = (keyword: string, userTimezone: string): Promise<NaturalDateResponse> => {
...
export const testRegexValidity = (regex: string): Promise<{ is_valid: boolean }> => {
...
export const urlAllowListCheck = (
  urlToCheck: string,
): Promise<{
  url: string;
...
export const urlAllowListGenerateRegex = (
  urlTemplate: string,
  placeholder: string,
): Promise<{
  url_template: string;
...
export const testSplitAndIndex = (
  splitBy: string,
  index: number,
  string: string,
): Promise<{
...
export const testContainsString = (
  searchString: string,
  string: string,
): Promise<{
