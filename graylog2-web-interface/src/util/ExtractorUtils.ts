...
type ExtractorConfiguration = Record<string, any>;
...
const ExtractorUtils = {
  ...
  getReadableExtractorTypeName(extractorType: string): string {
  ...
  getReadableConverterTypeName(converterType: string): string {
