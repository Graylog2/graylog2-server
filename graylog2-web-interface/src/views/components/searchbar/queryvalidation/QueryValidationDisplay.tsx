...
type Props = {
  queryStringErrors?: QueryValidationState;
  validationExplanations?: ValidationExplanations;
};

const QueryValidationDisplay = ({ queryStringErrors = undefined, validationExplanations = [] }: Props) => {
...
export default QueryValidationDisplay;
