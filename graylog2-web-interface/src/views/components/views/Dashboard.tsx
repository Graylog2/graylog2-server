...
const Dashboard = ({ children, id, title, summary, description, owner, requires, createdAt, requirementsProvided }) => (
...
export default withPluginEntities(Dashboard, { requirementsProvided: 'views.requires.provided' });
