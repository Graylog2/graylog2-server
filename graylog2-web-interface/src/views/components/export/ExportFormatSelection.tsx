...
const ExportFormatSelection = () => {
  ...
  const exportFormatOptions = exportFormats
    .sort((type1, type2) => defaultCompare(type1?.displayName, type2?.displayName))
      ...
      {({ field: { name, value, onChange } }) => (
        <>
          ...
          <Select
            ...
            onChange={(newFormat) => onChange({ target: { name, value: newFormat } })}
          />
        </>
      )}
    </Field>
