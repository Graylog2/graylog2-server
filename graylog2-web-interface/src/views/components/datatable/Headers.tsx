...
import { getPinnedCellClassName } from 'components/bootstrap';
...
const Headers = ({
  ...
  const seriesFields = series.map((s, index) =>
    headerField({
      ...
      showPinIcon: false,
      className: getPinnedCellClassName(pinnedColumnIndexes.has(index + rowFieldNames.length + lineNumberOffset), false),
    }),
  );
