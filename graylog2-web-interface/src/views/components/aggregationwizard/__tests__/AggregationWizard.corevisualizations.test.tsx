...
describe('AggregationWizard/Core Visualizations', () => {
  ...
  it(
    'creates Area Chart config when all required fields are present',
    async () => {
  ...
  it(
    'creates Bar Chart config when all required fields are present',
    async () => {
      const onChange = jest.fn();
  ...
  it(
    'creates Line Chart config when all required fields are present',
    async () => {
      const onChange = jest.fn();
  ...
  it(
    'allows enabling event annotations for visualizations supporting it',
    async () => {
      const onChange = jest.fn();
      const timelineConfig = widgetConfig
        .toBuilder()
  ...
  it(
    'creates Heatmap config when all required fields are present',
    async () => {
      const onChange = jest.fn();
  ...
  it(
    'creates Single Number config when all required fields are present',
    async () => {
      const onChange = jest.fn();
  ...
  it(
    'clears validation errors properly when switching visualization',
    async () => {
      const areaChart = widgetConfig
        .toBuilder()
  ...
  describe('has visualization-specific validation for aggregation config', () => {
    ...
    `(
      'expects constraints for $visualization',
