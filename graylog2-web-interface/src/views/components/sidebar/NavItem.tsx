...
const Container = styled.button<ContainerProps>(
  ({ theme: { colors, fonts }, $isSelected, $sidebarIsPinned, $disabled, $isLink }) => css`
    position: relative;
    display: flex;
    align-items: center;
...
const IconWrap = styled.span<IconWrapProps>(
  ({ $isSelected, $disabled, $isLink, $sidebarIsPinned, theme: { colors } }) => css`
    display: flex;
    ...
    &::after {
      ...
      box-shadow: ${$isSelected && !$sidebarIsPinned && !$isLink
