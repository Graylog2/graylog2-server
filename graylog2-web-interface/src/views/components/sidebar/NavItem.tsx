...
const Container = styled.button<ContainerProps>(
  ({ theme: { colors, fonts }, $isSelected, $sidebarIsPinned, $disabled }) => css`
    position: relative;
...
const IconWrap = styled.span<IconWrapProps>(
  ({ $showTitleOnHover, $isSelected, $disabled, $sidebarIsPinned, theme: { colors } }) => css`
    display: flex;
    width: 100%;
    height: 100%;
    align-items: center;
    ...
    &::after {
      ...
      box-shadow: ${$isSelected && !$sidebarIsPinned
        ? `inset 2px -2px 2px 0 ${colors.global.navigationBoxShadow}`
        : 'none'};
