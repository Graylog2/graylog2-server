  ...
  return (
    <Container className="widget-actions-menu">
      <IfInteractive>
        ...
        {isFocused && <IconButton name="compress-arrows-alt" title="Un-focus widget" onClick={unsetWidgetFocusing} />}
        {!isFocused && (
          <>
            <WidgetHorizontalStretch
              ...
              position={position}
            />
            <IconButton name="expand-arrows-alt" title="Focus this widget" onClick={focusWidget} />
          </>
        )}

        <IconButton name="edit" title="Edit" onClick={toggleEdit} />
