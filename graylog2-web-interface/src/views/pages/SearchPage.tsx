...
const SearchPage = ({ children, isNew, view: viewPromise, loadNewView = defaultLoadNewView, loadView = defaultLoadView, executionState: initialExecutionState, SearchComponentSlots }: Props) => {
