      ...
      children: [
        ...
        ...pluginRoutesWithAppParent,
        {
          ...
          children: [
            ...
            { path: RoutePaths.SYSTEM.INDICES.TEMPLATES.OVERVIEW, element: <IndexSetTemplatesPage /> },
            { path: RoutePaths.SYSTEM.INDICES.TEMPLATES.CREATE, element: <IndexSetTemplateCreatePage /> },
            { path: RoutePaths.SYSTEM.INDICES.TEMPLATES.edit(':templateId'), element: <IndexSetTemplateEditPage /> },
