...
const ApiRoutes = {
  AlarmCallbacksApiController: {
    ...
    update: (streamId, alarmCallbackId) => {
      return {url: `/streams/${streamId}/alarmcallbacks/${alarmCallbackId}`};
    },
  },
  ...
  DashboardsApiController: {
    ...
    widgetValue: (dashboardId, widgetId) => {
      return {url: `/dashboards/${dashboardId}/widgets/${widgetId}/value`};
    },
    updatePositions: (dashboardId) => {
  ...
  ClusterLoggersResource: {
    ...
    setSubsystemLoggerLevel: (nodeId, subsystem, loglevel) => {
  ...
  StreamAlertsApiController: {
    ...
    update: (streamId, alertConditionId) => {
      return {url: `/streams/${streamId}/alerts/conditions/${alertConditionId}`};
    },
    addReceiver: (streamId, type, entity) => {
      return {url: `/streams/${streamId}/alerts/receivers?entity=${entity}&type=${type}`};
    },
    deleteReceiver: (streamId, type, entity) => {
      return {url: `/streams/${streamId}/alerts/receivers?entity=${entity}&type=${type}`};
    },
    sendDummyAlert: (streamId) => {
  ...
  ExtractorsController: {
    ...
    delete: (inputId, extractorId) => {
      return {url: `/system/inputs/${inputId}/extractors/${extractorId}`};
    },
    toggle: (inputId, extractorId, status) => {
      return {url: `/system/inputs/${inputId}/extractors/${extractorId}/${status}`};
    },
    ...
    update: (inputId, extractorId) => {
      return {url: `/system/inputs/${inputId}/extractors/${extractorId}`};
    },
  },
  MessagesController: {
    single: (index, messageId) => {
      return {url: `/messages/${index}/${messageId}`};
    },
    analyze: (index, string) => {
