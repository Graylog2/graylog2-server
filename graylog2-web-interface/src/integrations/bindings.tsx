...
// Component prop types are narrower than PluginExports expects (contravariance in formComponent/summaryComponent/detailsComponent)
export default bindings as unknown as PluginExports;
