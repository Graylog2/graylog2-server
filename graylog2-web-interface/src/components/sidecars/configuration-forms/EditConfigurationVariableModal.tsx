...
type EditConfigurationVariableModalProps = {
  create?: boolean;
  id?: string;
  name?: string;
  description?: string;
  content?: string;
  saveConfigurationVariable: (...args: any[]) => void;
};

class EditConfigurationVariableModal extends React.Component<EditConfigurationVariableModalProps, {
  [key: string]: any;
}> {
  static defaultProps = {
    create: false,
