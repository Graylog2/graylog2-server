...
const ScrollContainerContext = React.createContext<ScrollContainerContextType | null>(null);
export default singleton('contexts.ScrollContainerContext', () => ScrollContainerContext);
