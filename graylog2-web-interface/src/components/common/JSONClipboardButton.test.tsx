...
describe('JSONClipboardButton', () => {
  ...
  it('should serialize a BigInt', async () => {
    ...
    render(<JSONClipboardButton content={content} title="Copy BigInt" />);
  ...
  it('should serialize an object containing a BigInt', async () => {
    ...
    render(<JSONClipboardButton content={content} title="Copy object" />);
  ...
  it('should serialize an array containing a BigInt', async () => {
    ...
    render(<JSONClipboardButton content={content} title="Copy array" />);
