...
const IndexSetFieldTypeDeleteModal = ({ show, onSubmitCallback, fieldTypes, isOptionsLoading, initialSelectedIndexSets, onClose, field, showSelectionTable, initialFieldType }: Props) => {
...
export default IndexSetFieldTypeDeleteModal;
