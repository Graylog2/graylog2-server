...
const validate = (formValues: IndexSetTemplateFormValues, usesLegacyRetention: boolean) => {
  ...
  if (!formValues.index_set_config.index_analyzer) {
    errors = {
      ...errors,
      index_set_config: { ...errors.index_set_config, index_analyzer: 'Index Analyzer is required' },
    };
  }
  ...
  if (!formValues.index_set_config.index_optimization_max_num_segments) {
    errors = {
      ...errors,
      index_set_config: {
        ...errors.index_set_config,
        index_optimization_max_num_segments: 'Maximum Number of Segments is required',
      },
    };
  }
...
const TemplateForm = ({
  ...
  const [selectedRetentionSegment, setSelectedRetentionSegment] =
  ...
  const handleSubmit = (values: IndexSetTemplateFormValues) => {
    let template = {};
    const { retention_strategy, retention_strategy_class, rotation_strategy, rotation_strategy_class, ...other } =
      values;
      ...
      index_set_config: {
        ...
        data_tiering:
          selectedRetentionSegment === 'legacy'
            ? undefined
            : prepareDataTieringConfig(index_set_config.data_tiering, PluginStore, false, true),
      },
    };
  ...
  const prepareInitialValues = () => {
    ...
    const data_tiering = prepareDataTieringInitialValues(values.index_set_config.data_tiering, PluginStore, false, true);
  ...
  return (
    <Row>
      <Col md={12}>
        <Formik<IndexSetTemplateFormValues>
              ...
              <Form>
                <FlexWrapper>
                  ...
                  <Section title="Details">
                    ...
                    />
                    <FormikInput
                      name="index_set_config.replicas"
                      label="Index Replica"
                      type="number"
                    ...
                    />
                    <FormikInput
                      name="index_set_config.index_optimization_max_num_segments"
                    ...
                    <FormikInput
                      ...
                      help={
                        <>
                          ...
                          active Index has been rotated and reduces the size of an Index on disk. It manifests as a CPU
                          intensive maintenance task performed by the search cluster after Index rotation. Compressing
                          Indexes improves search performance and decreases the storage footprint of Index Sets.
                        </>
                      }
                    />
