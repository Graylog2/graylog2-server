...
const ConfigSegmentsTitle = styled.h2(
  ({ theme }) => css`
...
const IndexSetConfigurationForm = ({
  ...
  const prepareRetentionConfigBeforeSubmit = useCallback(
    (values: IndexSetFormValues): IndexSet => {
      ...
      if (loadingIndexDefaultsConfig || !indexDefaultsConfig)
                  ...
                  <>
                    {indexSet.writable && (
                      <RotationStrategies
                        ...
                        indexSetRotationStrategy={indexSetRotationStrategy}
                        indexSetRotationStrategyClass={indexSetRotationStrategyClass}
                      />
                    )}
                    {indexSet.writable && (
                      <RetentionConfig
                        ...
                        retentionStrategiesContext={retentionStrategiesContext}
                        indexSetRetentionStrategy={indexSetRetentionStrategy}
                        IndexSetRetentionStrategyClass={IndexSetRetentionStrategyClass}
                      />
                    )}
                  </>
                ) : (
