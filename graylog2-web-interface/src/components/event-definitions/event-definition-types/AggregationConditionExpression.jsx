            ...
            <Col md={2}>
              <FormGroup>
                <div className={renderLabel ? styles.formControlNoLabel : undefined}>
                  <ButtonToolbar>
                    <Button bsSize="sm" onClick={this.handleDeleteExpression} title="Delete Expression"><Icon name="remove" fixedWidth /></Button>
                    <Button bsSize="sm" onClick={this.handleAddExpression} title="Add Expression"><Icon name="add" fixedWidth /></Button>
