...
describe('DecoratorsUpdater', () => {
  ...
  it('works for empty arrays', () =>
    DecoratorsUpdater([], []).then(() => {
      expect(mockCreate).not.toHaveBeenCalled();
      expect(mockUpdate).not.toHaveBeenCalled();
      expect(mockRemove).not.toHaveBeenCalled();
    }));

  it('finds a created decorator', () =>
    DecoratorsUpdater(
  ...
  it('finds a combination of created, updated & removed decorators', () =>
    DecoratorsUpdater(
      [
        decorator('decorator2'),
        decorator('new1', 'new type'),
        decorator('decorator3', 'bar!'),
        decorator('new2', 'other new type'),
        decorator('decorator4', 'something else'),
      ],
      [
        decorator('decorator1'),
        decorator('decorator2'),
        decorator('decorator4', 'something'),
        decorator('decorator3', 'foo!'),
      ],
    ).then(() => {
