              ...
              <div className="col-md-5" style={{ padding: 0 }}>
                ...
                <DatePicker id="searchFromDatePicker"
                  ...
                  <Input type="text"
                         ...
                         buttonAfter={<Button bsSize="small" onClick={this._setDateTimeToNow('from')}><Icon className="fa fa-magic" /></Button>}
              ...
              <div className="col-md-5" style={{ padding: 0 }}>
                ...
                <DatePicker id="searchToDatePicker"
                  ...
                  <Input type="text"
                         ...
                         placeholder={DateTime.Formats.DATETIME}
                         buttonAfter={<Button bsSize="small" onClick={this._setDateTimeToNow('to')}><Icon className="fa fa-magic" /></Button>}
