...
export default (payload: WizardSubmitPayload, formValues: WizardFormValues, serviceType: AuthBackendMeta['serviceType'], shouldUpdateGroupSync: boolean | undefined = true) => {
