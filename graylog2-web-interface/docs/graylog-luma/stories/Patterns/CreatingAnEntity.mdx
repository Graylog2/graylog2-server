...
import { DIAGRAM } from './CreatingAnEntity.constants';
...
<Unstyled>
  <Alert bsStyle="info">
    ...
    before implementation. Context decisions affect navigation, workflow continuity, and long-term consistency across
    the product.
  </Alert>
</Unstyled>
