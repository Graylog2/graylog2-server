 ...
 */
package org.graylog.datanode.featureflag;
...
import static org.graylog.datanode.bootstrap.CmdLineTool.GRAYLOG_DATANODE_ENVIRONMENT_VAR_PREFIX;
import static org.graylog.datanode.bootstrap.CmdLineTool.GRAYLOG_DATANODE_SYSTEM_PROP_PREFIX;
...
public class ImmutableFeatureFlagsCollector {

    private static final Logger LOG = LoggerFactory.getLogger(ImmutableFeatureFlagsCollector.class);

    private static final String GRAYLOG_FF_ENVIRONMENT_VAR_PREFIX = GRAYLOG_DATANODE_ENVIRONMENT_VAR_PREFIX + "FEATURE_";
    private static final String GRAYLOG_FF_SYSTEM_PROP_PREFIX = GRAYLOG_DATANODE_SYSTEM_PROP_PREFIX + "feature.";
