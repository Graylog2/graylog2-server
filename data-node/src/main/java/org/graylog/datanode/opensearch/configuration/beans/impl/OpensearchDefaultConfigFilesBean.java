...
public class OpensearchDefaultConfigFilesBean implements DatanodeConfigurationBean<OpensearchConfigurationParams> {
    ...
    @Nonnull
    private static String opensearchPolicyFilePath(Path targetConfigDir) {
        // we need absolute path here, that's why we are utilizing the (temp, autogenerated) target config dir
        return targetConfigDir.resolve("opensearch.policy").toAbsolutePath().toString();
    }
