...
public class HttpConfiguration {
    ...
    private static final int GRAYLOG_DATANODE_DEFAULT_PORT = 8999;

    public static final String OVERRIDE_HEADER = "X-Graylog-Server-URL";
    public static final String PATH_WEB = "";
    public static final String PATH_API = "api/";

    @Parameter(value = "datanode_bind_address", required = true)
    ...
    public HostAndPort getHttpBindAddress() {
        return httpBindAddress
                ...
                .withDefaultPort(GRAYLOG_DATANODE_DEFAULT_PORT);
    }
    ...
    public URI getHttpPublishUri() {
        if (httpPublishUri == null) {
            ...
            if (Tools.isWildcardInetAddress(inetAddress)) {
                ...
                return Tools.normalizeURI(httpPublishUri, httpPublishUri.getScheme(), GRAYLOG_DATANODE_DEFAULT_PORT, httpPublishUri.getPath());
            }
        }
    }
