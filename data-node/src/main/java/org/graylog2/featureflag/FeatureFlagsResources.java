...
public class FeatureFlagsResources {

    public Map<String, String> defaultProperties(String file) throws IOException {
        return loadProperties(FeatureFlagsResources.class.getResourceAsStream(file));
    }

    public Map<String, String> customProperties(String file) throws IOException {
