...
public class DatanodeSecuritySetupIT {
    ...
    void setUp() {
        ...
        backend = new DatanodeContainerizedBackend(datanodeContainer -> {
            ...
            datanodeContainer.withFileSystemBind(nodeCert.toAbsolutePath().toString(), IMAGE_WORKING_DIR + "/config/opensearch/datanode-transport-certificates.p12");
            datanodeContainer.withFileSystemBind(httpCert.toAbsolutePath().toString(), IMAGE_WORKING_DIR + "/config/opensearch/datanode-https-certificates.p12");
