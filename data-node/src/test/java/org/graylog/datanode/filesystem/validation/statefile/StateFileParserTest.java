 ...
 */
package org.graylog.datanode.filesystem.validation.statefile;
...
class StateFileParserTest {
    ...
    void parseOpensearch2() throws URISyntaxException {
        final URI uri = getClass().getResource("/indices/opensearch/nodes/0/_state/node-1.st").toURI();
    ...
    void parseElasticsearch7() throws URISyntaxException {
        final URI uri = getClass().getResource("/indices/elasticsearch/nodes/0/_state/node-0.st").toURI();
        final StateFile stateFile = parser.parse(Path.of(uri));
