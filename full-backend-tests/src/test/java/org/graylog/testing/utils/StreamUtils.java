...
public final class StreamUtils {
    ...
    public static String createStream(GraylogApis api, String title, String indexSetId, StreamRule... streamRules) {
    ...
    public static ValidatableResponse getStream(GraylogApis api, String streamId) {
        return given()
                .spec(api.requestSpecification())
                .when()
