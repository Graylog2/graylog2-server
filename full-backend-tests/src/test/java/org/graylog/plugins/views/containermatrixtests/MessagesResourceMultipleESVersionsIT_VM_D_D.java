...
@ContainerMatrixTestsConfiguration(serverLifecycle = VM, esVersions = {ES6, ES7}, mongoVersions = {MONGO3, MONGO4}, extraPorts = {44000})
class MessagesResourceMultipleESVersionsIT_VM_D_D {
    private GraylogBackend backend;
    private RequestSpecification requestSpec;

    public MessagesResourceMultipleESVersionsIT_VM_D_D(GraylogBackend backend, RequestSpecification specification) {
    ...
    public void canDownloadCsv() {
        backend.importElasticsearchFixture("messages-for-export.json", MessagesResourceMultipleESVersionsIT_VM_D_D.class);
