...
@ContainerMatrixTestsConfiguration(serverLifecycle = CLASS, esVersions = {ES6, ES7}, mongoVersions = {MONGO3, MONGO4}, extraPorts = {41000, 43000})
class MessagesResourceMultipleESVersionsIT2_CLASS_D_D {
    private GraylogBackend backend;
    private RequestSpecification requestSpec;

    public MessagesResourceMultipleESVersionsIT2_CLASS_D_D(GraylogBackend backend, RequestSpecification specification) {
    ...
    public void canDownloadCsv() {
        backend.importElasticsearchFixture("messages-for-export.json", MessagesResourceMultipleESVersionsIT2_CLASS_D_D.class);
