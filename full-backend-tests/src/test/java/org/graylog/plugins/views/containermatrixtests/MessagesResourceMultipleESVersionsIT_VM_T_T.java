...
@ContainerMatrixTestsConfiguration(serverLifecycle = VM,
                                   esVersions = {ES6, ES7},
                                   mongoVersions = {MONGO3, MONGO4},
                                   pluginJarsProvider = TestPluginJarsProvider.class,
                                   mavenProjectDirProvider = TestMavenProjectDirProvider.class)
class MessagesResourceMultipleESVersionsIT_VM_T_T {
    private GraylogBackend backend;
    private RequestSpecification requestSpec;

    public MessagesResourceMultipleESVersionsIT_VM_T_T(GraylogBackend backend, RequestSpecification specification) {
    ...
    public void canDownloadCsv() {
        backend.importElasticsearchFixture("messages-for-export.json", MessagesResourceMultipleESVersionsIT_VM_T_T.class);
