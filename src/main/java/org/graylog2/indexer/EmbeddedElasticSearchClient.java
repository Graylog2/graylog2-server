...
public class EmbeddedElasticSearchClient extends Indexer {
    ...
    public EmbeddedElasticSearchClient(GraylogServer graylogServer) {
        super(graylogServer);
        final Configuration config = graylogServer.getConfiguration();

        final NodeBuilder builder = nodeBuilder().client(true);
        String esSettings = null;
        Map<String, String> settings = null;
        try {
            esSettings = FileUtils.readFileToString(new File(config.getElasticSearchConfigFile()));
