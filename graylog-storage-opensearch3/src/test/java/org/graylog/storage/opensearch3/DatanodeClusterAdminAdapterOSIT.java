...
class DatanodeClusterAdminAdapterOSIT extends DatanodeClusterAdminAdapterIT {
    ...
    protected DatanodeClusterAdminAdapter createAdapter() {
        return new DatanodeClusterAdminAdapterOS(openSearchInstance.getOfficialOpensearchClient(), new ObjectMapper());
    }
