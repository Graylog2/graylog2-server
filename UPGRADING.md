...
The AlienVault OTX lookup data adapter now enforces the [URL allowlist](https://go2docs.graylog.org/current/setting_up_graylog/url_allowlisting.htm)
on startup. Any OTX adapter whose configured API URL is not present in the allowlist will be blocked
