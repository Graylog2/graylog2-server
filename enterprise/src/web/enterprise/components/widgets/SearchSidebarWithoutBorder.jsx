...
const SearchSidebarWithoutBorder = createReactClass({
  displayName: 'SearchSidebarWithoutBorder',
  ...
  render() {
    ...
    return (
      <AutoAffix affixClassName="affix">
        <div ref="sidebar" id="sidebar" style={{ top: undefined, position: undefined }}>
          <div>
            <p style={{ marginTop: 3 }}>
...
export default SearchSidebarWithoutBorder;
