...
import AddAlertStatusActionHandler from 'enterprise/logic/fieldactions/AddAlertStatusActionHandler';
...
const AddWidgetButton = () => (
  <DropdownButton title="Add Widget" id="add-widget-button-dropdown" bsStyle="info" pullRight>
    ...
    <MenuItem onSelect={AddAlertStatusActionHandler}>Alert Status</MenuItem>
