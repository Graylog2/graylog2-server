...
import DashboardWidgetsStore from 'enterprise/stores/DashboardWidgetsStore';
...
const SaveViewModal = ({ currentView, search, selectedFields, titles, views, widgets, dashboardWidgets, show, onClose, onSaveFinished }) => {
  const onSave = view => ViewActions.save(undefined, currentView, view, widgets, dashboardWidgets, selectedFields, search, titles)
    .then(onSaveFinished);
...
export default connect(SaveViewModal, {
  ...
  views: ViewsStore,
  widgets: WidgetStore,
  dashboardWidgets: DashboardWidgetsStore,
});
