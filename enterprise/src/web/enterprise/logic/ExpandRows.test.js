...
describe('ExpandRows', () => {
  it('normalizes empty array', () => {
    const data = [];
    const result = expandRows(['controller'], [], ['count'], data);
  ...
  it('properly expands a simple result from a pivot search type', () => {
    ...
    const result = expandRows(['timestamp', 'controller'], ['action'], ['count()', 'sum(took_ms)'], pivotResult);
  ...
  it('properly expands a result with two column pivots', () => {
    ...
    const result = expandRows(['timestamp'], ['action', 'controller'], ['count()', 'sum(took_ms)'], pivotResult);
