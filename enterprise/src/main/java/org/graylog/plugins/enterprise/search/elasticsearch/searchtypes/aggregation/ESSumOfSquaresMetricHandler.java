...
import org.graylog.plugins.enterprise.search.searchtypes.aggregation.SumOfSquaresMetric;
import org.jooq.lambda.tuple.Tuple2;

import javax.annotation.Nonnull;
import java.util.Optional;

public class ESSumOfSquaresMetricHandler implements ESAggregationSpecHandler<SumOfSquaresMetric, ExtendedStatsAggregation> {

    @Nonnull
    @Override
    public Optional<AggregationBuilder> doCreateAggregation(String name, SumOfSquaresMetric metricSpec, ESAggregation aggregationSearchTypeHandler, ESGeneratedQueryContext queryContext) {
    ...
    @Override
    public SumOfSquaresMetric.Result doHandleResult(SumOfSquaresMetric aggregationSpec, SearchResult queryResult, ExtendedStatsAggregation extendedStatsAggregation, ESAggregation searchTypeHandler, ESGeneratedQueryContext queryContext) {
        return SumOfSquaresMetric.Result.create(extendedStatsAggregation.getSumOfSquares());
    }
