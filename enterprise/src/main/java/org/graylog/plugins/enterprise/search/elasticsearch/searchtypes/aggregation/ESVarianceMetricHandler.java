...
import org.graylog.plugins.enterprise.search.searchtypes.aggregation.VarianceMetric;
import org.jooq.lambda.tuple.Tuple2;

import javax.annotation.Nonnull;
import java.util.Optional;

public class ESVarianceMetricHandler implements ESAggregationSpecHandler<VarianceMetric, ExtendedStatsAggregation> {

    @Nonnull
    @Override
    public Optional<AggregationBuilder> doCreateAggregation(String name, VarianceMetric metricSpec, ESAggregation aggregationSearchTypeHandler, ESGeneratedQueryContext queryContext) {
    ...
    @Override
    public VarianceMetric.Result doHandleResult(VarianceMetric aggregationSpec, SearchResult queryResult, ExtendedStatsAggregation extendedStatsAggregation, ESAggregation searchTypeHandler, ESGeneratedQueryContext queryContext) {
        return VarianceMetric.Result.create(extendedStatsAggregation.getVariance());
    }
