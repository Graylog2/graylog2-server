...
import org.graylog.plugins.enterprise.search.elasticsearch.searchtypes.pivot.buckets.ESValuesHandler;
...
import org.graylog.plugins.enterprise.search.searchtypes.pivot.buckets.AutoInterval;
...
public class ESPivotTest {
    ...
    public void columnPivotsShouldBeNested() {
        ...
        extractAggregation(context, "values-agg.time-agg")
                .isEqualTo("Time{type=time, field=timestamp, interval=AutoInterval{type=auto}}");
    }
