...
class CollectorsConfigResourceTest {
    ...
    void putRejectsZeroVisibilityThreshold() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, Duration.ZERO, null, null, false
        );
    ...
    void putRejectsVisibilityThresholdBelowOfflineThreshold() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, Duration.ofMinutes(3), null, null, false
        );
    ...
    void putRejectsExpirationNotGreaterThanVisibility() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, Duration.ofDays(2), Duration.ofDays(1), null, false
        );
    ...
    void putRejectsMultipleInvalidThresholds() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, Duration.ofMinutes(-5), Duration.ofMinutes(-10), null, false
        );
    ...
    void putAcceptsValidThresholds() throws ValidationException {
        ...
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                Duration.ofMinutes(10), Duration.ofHours(12), Duration.ofDays(3), Duration.ofDays(30), false
        );
        ...
        assertThat(result.collectorTransactionLogRetentionThreshold()).isEqualTo(Duration.ofDays(30));
    }
    ...
    void putAcceptsNullThresholds() throws ValidationException {
        ...
        assertThat(result.collectorDefaultVisibilityThreshold()).isEqualTo(CollectorsConfig.DEFAULT_VISIBILITY_THRESHOLD);
        assertThat(result.collectorExpirationThreshold()).isEqualTo(CollectorsConfig.DEFAULT_EXPIRATION_THRESHOLD);
        assertThat(result.collectorTransactionLogRetentionThreshold()).isEqualTo(CollectorsConfig.DEFAULT_COLLECTOR_TRANSACTION_LOG_RETENTION);
    }

    @Test
    void putRejectsZeroRetentionThreshold() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
        ...
        assertThatThrownBy(() -> resource.put(request))
                ...
                .satisfies(ex -> {
                    final var errors = ((ValidationException) ex).getErrors();
                    assertThat(errors).containsKey("collector_transaction_log_retention_threshold");
                    assertThat(((ValidationResult.ValidationFailed) errors.get("collector_transaction_log_retention_threshold").get(0)).getError())
                            .isEqualTo("Must be a positive duration");
                });
    }

    @Test
    void putRejectsRetentionBelowExpiration() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, null, Duration.ofDays(7), Duration.ofDays(5), false
        );
    ...
    @Test
    void putAcceptsRetentionEqualToExpiration() throws ValidationException {
        stubCaService();

        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                null, null, Duration.ofDays(7), Duration.ofDays(7), false
        );

        final var result = resource.put(request);

        assertThat(result.collectorTransactionLogRetentionThreshold()).isEqualTo(Duration.ofDays(7));
    }
    ...
    void putRejectsOfflineThresholdBelowOneMinute() {
        final var request = new CollectorsConfigRequest(
                new CollectorsConfigRequest.IngestEndpointRequest("host", 14401),
                Duration.ofSeconds(30), null, null, null, false
        );
    ...
    void putReusesTokenSigningKeyFromExistingConfig() throws Exception {
        ...
        final var existingConfig = CollectorsConfig.builder()
                ...
                .collectorTransactionLogRetentionThreshold(CollectorsConfig.DEFAULT_COLLECTOR_TRANSACTION_LOG_RETENTION)
                .build();
