...
class KinesisConsumerTest {
    ...
    private KinesisConsumer.ClientBuilders newClientBuilders() {
        when(awsClientBuilderUtil.asyncHttpClientBuilder()).thenReturn(NettyNioAsyncHttpClient.builder());
        when(awsClientBuilderUtil.kinesisAsyncHttpClientBuilder()).thenReturn(NettyNioAsyncHttpClient.builder());
