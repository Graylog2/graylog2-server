...
class ValidationMessageParserTest {
    ...
    void testMatchNoDocs() {
        final ValidationMessage parsed = ValidationMessageParser.getHumanReadableMessage("MatchNoDocsQuery(\"unmapped fields [not_existing_field]\")");
