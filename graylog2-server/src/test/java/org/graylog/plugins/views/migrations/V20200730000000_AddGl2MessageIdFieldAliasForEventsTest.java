...
class V20200730000000_AddGl2MessageIdFieldAliasForEventsTest {
    ...
    private V20200730000000_AddGl2MessageIdFieldAliasForEvents buildSut(int major) {
        return new V20200730000000_AddGl2MessageIdFieldAliasForEvents(SearchVersion.withoutDistribution(Version.from(major, 0, 0)), clusterConfigService, elasticsearchAdapter, elasticsearchConfig);
    }
