...
class NodeTitleDecoratorTest {
    ...
    void setUp() {
        ...
        nodeService.registerServer("5ca1ab1e-0000-4000-a000-000000000000", false, URI.create("http://my-host.example.com"), "my-host.example.com", true, LoadBalancerStatus.ALIVE);
