...
public class V20200505121200_EncryptAWSSecretKeyTest {
    ...
    public void doesNotDoAnyThingForMissingPluginConfig() {
        ...
        verify(clusterConfigService, never()).write(
                not(eq(V20200505121200_EncryptAWSSecretKey.MigrationCompleted.CLUSTER_CONFIG_KEY)), any());
        verify(clusterConfigService, times(1)).write(
                eq(V20200505121200_EncryptAWSSecretKey.MigrationCompleted.CLUSTER_CONFIG_KEY),
                any(V20200505121200_EncryptAWSSecretKey.MigrationCompleted.class));
    }
