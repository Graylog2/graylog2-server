...
public class LegacyAlertConditionMigratorTest {
    ...
    public void setUp() throws Exception {
        ...
        final DBJobTriggerService jobTriggerService = new DBJobTriggerService(mongoConnection, mongoJackObjectMapperProvider, mock(NodeId.class), clock, nodeService, 5);
