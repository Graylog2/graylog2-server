...
public class LegacyAlertConditionMigratorTest {
    ...
    public void setUp() throws Exception {
        ...
        final DBJobTriggerService jobTriggerService = new DBJobTriggerService(new MongoCollections(mongoJackObjectMapperProvider, mongoConnection), new SimpleNodeId("5ca1ab1e-0000-4000-a000-000000000000"), clock, schedulerCapabilitiesService, Duration.minutes(5));
        notificationService = new DBNotificationService(new MongoCollections(mongoJackObjectMapperProvider, mongoConnection), mock(EntityOwnershipService.class));
