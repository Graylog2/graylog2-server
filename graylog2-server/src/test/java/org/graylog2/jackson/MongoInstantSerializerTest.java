...
public class MongoInstantSerializerTest {
    private final ObjectMapper objectMapper = new ObjectMapperProvider().get();

    @Test
    public void serializeInstant() throws Exception {
        final TestBean testBean = new TestBean(Instant.parse("2016-12-13T14:00:00.000Z"));
        final String valueAsString = objectMapper.writeValueAsString(testBean);
        assertThat(valueAsString)
                .isNotNull()
                .isEqualTo("{\"instant\":\"2016-12-13T14:00:00.000+0000\"}");
    }
    ...
    static class TestBean {
        ...
        public TestBean(Instant instant) {
