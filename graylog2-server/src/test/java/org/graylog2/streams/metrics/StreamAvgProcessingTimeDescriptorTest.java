...
class StreamAvgProcessingTimeDescriptorTest {

    private MoreSearch moreSearch;
    private StreamAvgProcessingTimeDescriptor descriptor;

    @BeforeEach
    void setUp() {
        moreSearch = mock(MoreSearch.class);
        descriptor = new StreamAvgProcessingTimeDescriptor(moreSearch, Duration.ofMinutes(1));
    }
    ...
    void computeForUser_returnsValueAsIs() {
        assertThat(descriptor.computeForUser(42.5, null)).isEqualTo(42.5);
    }
}
