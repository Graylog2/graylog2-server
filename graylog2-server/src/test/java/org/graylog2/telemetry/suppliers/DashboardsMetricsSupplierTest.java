...
public class DashboardsMetricsSupplierTest {
    @Mock
    private DashboardService dashboardService;

    @InjectMocks
    private DashboardsMetricsSupplier dashboardsMetricsSupplier;

    @Test
    public void shouldReturnDashboardsMetrics() {
        Map<String, Long> counts = Map.of(
                "illuminate_dashboards", 5L,
                "user_dashboards", 2L
        );
