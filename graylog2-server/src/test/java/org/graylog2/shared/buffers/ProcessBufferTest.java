...
public class ProcessBufferTest {
    ...
    public void testBasicInsert() throws Exception {
        ProcessBuffer processBuffer = new ProcessBuffer(metricRegistry, serverStatus, mock(BaseConfiguration.class), mock(InputCache.class), new ProcessBufferWatermark());
