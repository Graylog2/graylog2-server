...
public class SyslogTCPFramingRouterHandlerTest {
    ...
    @Test
    public void testBufferReleasedAfterSuccessfulDecode() {
    ...
    @Test
    public void testIncompleteFrameReleasedOnChannelClose() {
    ...
    @Test
    public void testMultipleMessagesBuffersReleased() {
    ...
    @Test
    public void testMultiPartBuffersReleasedAfterDecode() {
        final ByteBuf buf1 = Unpooled.copiedBuffer("<45>", StandardCharsets.US_ASCII);
        final ByteBuf buf2 = Unpooled.copiedBuffer("Test 123\n", StandardCharsets.US_ASCII);
    ...
    @Test
    public void testNotWorkingSyslogMessage() throws IOException {
