...
class IndexMapping7Test extends IndexMappingTestBase {
    private final IndexMapping7 indexMapping = new IndexMapping7();
    ...
    void generateDefaultTemplate() throws Exception {
        ...
        JSONAssert.assertEquals(json(sampleIndexTemplate), resourceFile("expected_template7.json"), true);
    }
}
