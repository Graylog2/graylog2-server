...
public class TextFieldTest {
    ...
    public void testGetFieldType() throws Exception {
        TextField f = new TextField("test", "default", "description");
    ...
    public void testIsOptional() throws Exception {
        TextField f = new TextField("test", "default", "description", ConfigurationField.Optional.OPTIONAL);
        assertEquals(ConfigurationField.Optional.OPTIONAL, f.isOptional());

        TextField f2 = new TextField("test", "default", "description", ConfigurationField.Optional.NOT_OPTIONAL);
    ...
    public void testGetAttributes() throws Exception {
        ...
        TextField f1 = new TextField("test", "default", "description", TextField.Attribute.IS_SOCKET_ADDRESS);
        assertEquals(1, f1.getAttributes().size());
        assertTrue(f1.getAttributes().contains("is_socket_address"));

        TextField f2 = new TextField("test", "default", "description", TextField.Attribute.IS_SOCKET_ADDRESS, TextField.Attribute.IS_PASSWORD);
