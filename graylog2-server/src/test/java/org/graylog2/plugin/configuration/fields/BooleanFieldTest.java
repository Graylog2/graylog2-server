...
public class BooleanFieldTest {
    ...
    public void testGetFieldType() throws Exception {
        BooleanField f = new BooleanField("name", false, "description");
    ...
    public void testGetDefaultValue() throws Exception {
        BooleanField f = new BooleanField("name", true, "description");
        assertEquals(true, f.getDefaultValue());
    }

    @Test
    public void testIsOptional() throws Exception {
        BooleanField f = new BooleanField("name", true, "description", ConfigurationField.Optional.NOT_OPTIONAL);
