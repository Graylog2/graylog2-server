...
public class NumberFieldTest {
    ...
    public void testGetFieldType() throws Exception {
        NumberField f = new NumberField("test", 0, "foo", ConfigurationField.Optional.NOT_OPTIONAL);
    ...
    public void testGetDefaultValue() throws Exception {
        NumberField f = new NumberField("test", 9001, "foo", ConfigurationField.Optional.NOT_OPTIONAL);
    ...
    public void testIsOptional() throws Exception {
        ...
        NumberField f2 = new NumberField("test", 0, "foo", ConfigurationField.Optional.OPTIONAL);
    ...
    public void testGetAttributes() throws Exception {
        ...
        NumberField f1 = new NumberField("test", 0, "foo", NumberField.Attribute.IS_PORT_NUMBER);
        assertEquals(1, f1.getAttributes().size());
        assertTrue(f1.getAttributes().contains("is_port_number"));

        NumberField f2 = new NumberField("test", 0, "foo", NumberField.Attribute.IS_PORT_NUMBER, NumberField.Attribute.ONLY_POSITIVE);
