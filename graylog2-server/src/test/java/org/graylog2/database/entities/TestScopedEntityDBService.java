...
public class TestScopedEntityDBService extends ScopedDbService<TestScopedEntity> {
    ...
    @Inject
    public TestScopedEntityDBService(MongoConnection mongoConnection,
                                     MongoJackObjectMapperProvider mapper,
                                     EntityScopeService entityScopeService) {
        super(mongoConnection, mapper, TestScopedEntity.class, COLLECTION_NAME, entityScopeService);
    }
}
