...
public class LookupCacheCatalogTest {
    ...
    public void setUp() throws Exception {
        final DBCacheService cacheService = new DBCacheService(mongoRule.getMongoConnection(), new MongoJackObjectMapperProvider(objectMapper));
    ...
    public void supports() {
        ...
        assertThat(catalog.supports(ModelType.of("lookup_cache"))).isTrue();
    }
    ...
    public void collectEntity() {
        final Optional<Entity> collectedEntity = catalog.collectEntity(EntityDescriptor.create(ModelId.of("no-op-cache"), ModelTypes.LOOKUP_CACHE));
