...
public class ViewFacadeTest {
    ...
    public void setUp(MongoDBTestService dbTestService) {
        ...
        final EntitySharesService sharesService = mock(EntitySharesService.class);

        facade = new SearchFacade(objectMapper, searchDbService, viewService, viewSummaryService, userService, sharesService);
    }
