...
public class DashboardV1FacadeTest {
    ...
    public void setUp(MongoCollections mongoCollections) throws IOException {
        ...
        EntitySharesService sharesService = mock(EntitySharesService.class);
        ...
        DashboardV1Facade facade = new DashboardV1Facade(objectMapper, searchDbService, entityConverter, viewService, viewSummaryService, userService, sharesService);
