...
class IndicesResourceTest {
    ...
    void getOutdatedIndicesSucceeds() {
        List<OutdatedIndex> outdatedIndices = List.of(
                new OutdatedIndex("outdated1", "1.3.0", false, false, false),
                new OutdatedIndex("outdated2", "1.3.0", true, true, true)
        );
    ...
    void reindexSucceeds() {
        when(outdatedIndexService.getOutdatedIndices()).thenReturn(List.of(new OutdatedIndex(".outdated1", "1.3.0", false, false, false)));
