...
public class OTelTraceService extends TraceServiceGrpc.TraceServiceImplBase {
    ...
    @Inject
    public OTelTraceService(@Assisted ThrottleableTransport2 transport, @Assisted MessageInput input,
    ...
    public interface Factory {
        OTelTraceService create(ThrottleableTransport2 transport, MessageInput input);
    }
    ...
    public void export(ExportTraceServiceRequest request,
        ...
        journalRecordFactory.createFromTraceRequest(request).stream()
