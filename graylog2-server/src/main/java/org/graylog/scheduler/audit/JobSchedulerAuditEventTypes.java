...
public class JobSchedulerAuditEventTypes implements PluginAuditEventTypes {
    public static final String SCHEDULER_JOB_CREATE = "scheduler_job:create";
    public static final String SCHEDULER_JOB_DELETE = "scheduler_job:delete";
    public static final String SCHEDULER_JOB_UPDATE = "scheduler_job:update";
    public static final String SCHEDULER_TRIGGER_CREATE = "scheduler_trigger:create";
