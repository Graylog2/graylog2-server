...
@DbEntity(collection = DBNotificationService.NOTIFICATION_COLLECTION_NAME,
          readPermission = RestPermissions.EVENT_NOTIFICATIONS_READ,
          titleField = NotificationDto.FIELD_TITLE)
