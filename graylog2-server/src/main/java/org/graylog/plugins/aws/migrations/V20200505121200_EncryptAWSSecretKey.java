 ...
 */
package org.graylog.plugins.aws.migrations;
...
public class V20200505121200_EncryptAWSSecretKey extends Migration {
    ...
    @Override
    public void upgrade() {
        if (clusterConfigService.get(MigrationCompleted.CLUSTER_CONFIG_KEY, MigrationCompleted.class) != null) {
        ...
        clusterConfigService.write(MigrationCompleted.CLUSTER_CONFIG_KEY, MigrationCompleted.create());
    }
    ...
    public static abstract class MigrationCompleted {
        public static String CLUSTER_CONFIG_KEY =
                "org.graylog.aws.migrations.V20200505121200_EncryptAWSSecretKey.MigrationCompleted";
        @JsonCreator
