 ...
 */
public class MongoDbRuleBuilderService implements RuleService {
    private static final RateLimitedLog log = getRateLimitedLog(MongoDbRuleBuilderService.class);

    private static final String COLLECTION = "pipeline_processor_rulebuilder";

    private final JacksonDBCollection<RuleDao, String> dbCollection;
    private final ClusterEventBus clusterBus;

    @Inject
    public MongoDbRuleBuilderService(MongoConnection mongoConnection,
