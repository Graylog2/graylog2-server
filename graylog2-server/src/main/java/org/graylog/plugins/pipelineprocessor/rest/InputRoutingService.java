...
public class InputRoutingService {
    ...
    @Inject
    public InputRoutingService(RuleService ruleService, InputService inputService, StreamService streamService) {
    ...
    private String getSystemRuleName(String inputName, String streamName) {
        return "route_" + inputName + "_to_" + streamName;
    }

    public boolean isSystemRulePattern(String ruleName) {
        return ruleName.matches("route_.*_to_.*");
    }
}
