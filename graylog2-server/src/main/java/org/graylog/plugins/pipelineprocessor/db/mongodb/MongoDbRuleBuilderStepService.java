 ...
 */
public class MongoDbRuleBuilderStepService implements RuleService {
    private static final RateLimitedLog log = getRateLimitedLog(MongoDbRuleBuilderStepService.class);
    ...
    @Inject
    public MongoDbRuleBuilderStepService(MongoConnection mongoConnection,
