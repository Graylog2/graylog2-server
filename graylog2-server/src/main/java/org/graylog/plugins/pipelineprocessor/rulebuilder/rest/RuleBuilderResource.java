...
public class RuleBuilderResource extends RestResource implements PluginRestResource {
    ...
    public RuleSource createFromParser(@ApiParam(name = "rule", required = true) @NotNull RuleBuilderRule ruleBuilderRule) throws ParseException {
        RuleSource ruleSource = RuleSource.builder()
