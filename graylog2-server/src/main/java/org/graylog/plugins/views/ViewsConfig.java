...
public class ViewsConfig implements PluginConfigBean {
    ...
    @Documentation(value = "Maximum age of searches that are not referenced by any saved search or dashboard before they are deleted by the periodic cleanup job. (Default: 4 days)")
