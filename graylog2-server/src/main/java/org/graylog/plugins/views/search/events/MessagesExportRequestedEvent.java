...
@AutoValue
@JsonAutoDetect
public abstract class MessagesExportRequestedEvent {

    public static MessagesExportRequestedEvent from(DateTime startTime, String userName, ExportMessagesCommand command) {
    ...
    public abstract static class Builder {
        ...
        abstract MessagesExportRequestedEvent autoBuild();

        public MessagesExportRequestedEvent build() {
            return autoBuild();
        }

        @JsonCreator
        public static Builder create() {
            return new AutoValue_MessagesExportRequestedEvent.Builder();
        }
    }
