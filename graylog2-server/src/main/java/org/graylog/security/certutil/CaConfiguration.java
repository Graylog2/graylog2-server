...
public class CaConfiguration extends BaseConfiguration {
    @Documentation("Path to a PKCS12 keystore with an existing CA used to sign certificates, instead of a CA generated by Graylog and stored in the database.")
    @Parameter(value = "ca_keystore_file")
    private Path caKeystoreFile;

    @Documentation("Password for the CA keystore configured in \"ca_keystore_file\".")
