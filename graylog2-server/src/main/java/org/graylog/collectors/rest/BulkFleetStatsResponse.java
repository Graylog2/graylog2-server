...
public record BulkFleetStatsResponse(@JsonProperty("fleets") List<FleetStatsSummary> fleets) {

    public record FleetStatsSummary(
            @JsonProperty("fleet_id") String fleetId,
            @JsonProperty("fleet_name") String fleetName,
