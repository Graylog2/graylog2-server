...
public class DecoratorResource extends RestResource {
    ...
    @AuditEvent(action = AuditActions.MESSAGE_DECORATOR_CREATE)
    ...
    @AuditEvent(action = AuditActions.MESSAGE_DECORATOR_DELETE)
    ...
    @AuditEvent(action = AuditActions.MESSAGE_DECORATOR_UPDATE)
