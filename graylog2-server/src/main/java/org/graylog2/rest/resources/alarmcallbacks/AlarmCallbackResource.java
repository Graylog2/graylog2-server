...
public class AlarmCallbackResource extends RestResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @AuditLog(action = AuditActions.ALARM_CALLBACK_CREATE)
    ...
    @AuditLog(action = AuditActions.ALARM_CALLBACK_DELETE)
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @AuditLog(action = AuditActions.ALARM_CALLBACK_UPDATE)
