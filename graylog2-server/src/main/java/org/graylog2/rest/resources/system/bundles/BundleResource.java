...
public class BundleResource extends RestResource {
    ...
    @AuditEvent(type = AuditEventTypes.CONTENT_PACK_UPDATE)
    ...
    @AuditEvent(type = AuditEventTypes.CONTENT_PACK_APPLY)
    ...
    @AuditEvent(type = AuditEventTypes.CONTENT_PACK_EXPORT)
