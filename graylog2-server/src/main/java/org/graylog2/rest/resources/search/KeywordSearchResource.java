...
public class KeywordSearchResource extends SearchResource {
    ...
    @Inject
    public KeywordSearchResource(Searches searches, MetricRegistry metricRegistry, @Named("query_time_range_limit") @Nullable Duration timeRangeLimit) {
    ...
    private TimeRange buildKeywordTimeRange(String keyword) {
        try {
            return restrictTimeRange(new KeywordRange(keyword));
