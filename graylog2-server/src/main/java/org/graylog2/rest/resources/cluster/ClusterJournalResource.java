...
@Tag(name = "Cluster/Journal", description = "Journal information of any nodes in the cluster")
...
public class ClusterJournalResource extends ProxiedResource {
    ...
    @GET
    @Timed
    @Operation(summary = "Get message journal information of a given node")
    @RequiresPermissions(RestPermissions.JOURNAL_READ)
    public JournalSummaryResponse get(@Parameter(name = "nodeId", description = "The id of the node to get message journal information.", required = true)
