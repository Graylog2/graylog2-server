...
@AutoValue
@JsonDeserialize(builder = TokenUsageDTO.Builder.class)
public abstract class TokenUsageDTO implements MongoEntity {
    ...
    public static abstract class Builder {
        ...
        @JsonCreator
        public static TokenUsageDTO.Builder create() {
            return new AutoValue_TokenUsageDTO.Builder();
        }
        ...
        public abstract TokenUsageDTO build();
    }
}
