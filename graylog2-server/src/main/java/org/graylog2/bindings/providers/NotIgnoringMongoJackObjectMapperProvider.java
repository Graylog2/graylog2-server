...
@Singleton
public class NotIgnoringMongoJackObjectMapperProvider implements Provider<ObjectMapper> {
    private final ObjectMapper objectMapper;

    @Inject
    public NotIgnoringMongoJackObjectMapperProvider(ObjectMapper objectMapper) {
