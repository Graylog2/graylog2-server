...
public class V20170607164210_MigrateReopenedIndicesToAliasesClusterStateAdapterProvider extends VersionAwareProvider<V20170607164210_MigrateReopenedIndicesToAliases.ClusterState> {
    @Inject
    public V20170607164210_MigrateReopenedIndicesToAliasesClusterStateAdapterProvider(@DetectedSearchVersion SearchVersion version, Map<SearchVersion, Provider<V20170607164210_MigrateReopenedIndicesToAliases.ClusterState>> pluginBindings) {
