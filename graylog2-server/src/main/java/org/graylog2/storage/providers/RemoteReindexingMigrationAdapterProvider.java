...
public class RemoteReindexingMigrationAdapterProvider extends VersionAwareProvider<RemoteReindexingMigrationAdapter> {
    @Inject
    public RemoteReindexingMigrationAdapterProvider(@DetectedSearchVersion SearchVersion indexerVersion, Map<SearchVersion, Provider<RemoteReindexingMigrationAdapter>> pluginBindings) {
