...
public class RawKafkaInputLegacy extends MessageInput {
    private static final String NAME = "Raw/Plaintext Kafka Legacy";

    @AssistedInject
    public RawKafkaInputLegacy(@Assisted Configuration configuration,
    ...
    protected RawKafkaInputLegacy(MetricRegistry metricRegistry,
    ...
    @FactoryClass
    public interface Factory extends MessageInput.Factory<RawKafkaInputLegacy> {
        @Override
        RawKafkaInputLegacy create(Configuration configuration);
    ...
    public static class Config extends MessageInput.Config {
        @Inject
        public Config(KafkaLegacyTransport.Factory transport, RawCodec.Factory codec) {
