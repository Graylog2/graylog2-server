...
public class JsonExtractor extends Extractor {
    ...
    public JsonExtractor(final MetricRegistry metricRegistry,
                         ...
                         final int status) throws ReservedFieldException, ConfigurationException {
        super(metricRegistry, id, title, order, Type.JSON, cursorStrategy,
            sourceField, targetField, extractorConfig, creatorUserId, converters, conditionType, conditionValue, status);
