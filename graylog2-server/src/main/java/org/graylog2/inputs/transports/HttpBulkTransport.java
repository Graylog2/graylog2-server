...
public class HttpBulkTransport extends HttpTransport {

    @AssistedInject
    public HttpBulkTransport(@Assisted Configuration configuration,
        ...
        super(configuration, eventLoopGroup, eventLoopGroupFactory, nettyTransportConfiguration, throughputCounter,
                localRegistry, tlsConfiguration);
    ...
    @FactoryClass
    public interface Factory extends Transport.Factory<HttpBulkTransport> {
        @Override
        HttpBulkTransport create(Configuration configuration);
    ...
    @ConfigClass
    public static class Config extends HttpTransport.Config {
        // Inherit all config fields from HttpTransport.
    }
}
