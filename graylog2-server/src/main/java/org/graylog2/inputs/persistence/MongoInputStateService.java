...
@Singleton
public class MongoInputStateService implements InputStateService {
    private static final Logger LOG = LoggerFactory.getLogger(MongoInputStateService.class);
    ...
    @Inject
    public MongoInputStateService(MongoCollections mongoCollections, NodeId nodeId) {
