...
public class RestPermissions implements PluginPermissions {
    ...
    public static final String STREAM_OUTPUT_FILTERS_CREATE = "stream_output_filters:create";
    public static final String STREAM_OUTPUT_FILTERS_DELETE = "stream_output_filters:delete";
    public static final String STREAM_OUTPUT_FILTERS_EDIT = "stream_output_filters:edit";
    public static final String STREAM_OUTPUT_FILTERS_READ = "stream_output_filters:read";
