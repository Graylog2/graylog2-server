...
import org.graylog2.inputs.gelf.kafka.GELFKafkaInputLegacy;
...
import org.graylog2.inputs.raw.kafka.RawKafkaInputLegacy;
...
import org.graylog2.inputs.syslog.kafka.SyslogKafkaInputLegacy;
...
public class MessageInputBindings extends Graylog2Module {
    ...
    protected void configure() {
        ...
        installInput(inputMapBinder, RawKafkaInputLegacy.class, RawKafkaInputLegacy.Factory.class);
        ...
        installInput(inputMapBinder, SyslogKafkaInputLegacy.class, SyslogKafkaInputLegacy.Factory.class);
        ...
        installInput(inputMapBinder, GELFKafkaInputLegacy.class, GELFKafkaInputLegacy.Factory.class);
