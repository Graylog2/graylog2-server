...
import org.graylog2.inputs.raw.kafka.RawKafkaInputNew;
...
import org.graylog2.inputs.syslog.kafka.SyslogKafkaInputNew;
...
public class MessageInputBindings extends Graylog2Module {
    ...
    protected void configure() {
        ...
        installInput(inputMapBinder, RawKafkaInputNew.class, RawKafkaInputNew.Factory.class);
        ...
        installInput(inputMapBinder, SyslogKafkaInputNew.class, SyslogKafkaInputNew.Factory.class);
