...
public class LocalKafkaMessageQueueModule extends Graylog2Module {
    ...
    protected void configure() {
        ...
        bind(MessageQueueReader.class).to(LocalKafkaMessageQueueReader.class).in(Scopes.SINGLETON);
        ...
        serviceBinder.addBinding().to(LocalKafkaMessageQueueReader.class).in(Scopes.SINGLETON);
