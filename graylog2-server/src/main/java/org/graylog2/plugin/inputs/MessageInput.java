...
public abstract class MessageInput implements Stoppable {
    ...
    private final MessageInputSequencer sequenceNr;
    ...
    public MessageInput(MetricRegistry metricRegistry,
        ...
        sequenceNr = new MessageInputSequencer();
    }
    ...
    public void processRawMessage(RawMessage rawMessage) {
        ...
        rawMessage.setSequenceNr(sequenceNr.next(rawMessage.getTimestamp().getMillis()));
