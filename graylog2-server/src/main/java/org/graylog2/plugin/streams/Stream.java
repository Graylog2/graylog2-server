...
public interface Stream {
    ...
    /**
     * The ID of the stream for collector self-logs.
     */
    String COLLECTOR_LOGS_STREAM_ID = "000000000000000000000005";
    /**
     ...
     */
    ImmutableSet<String> NON_EDITABLE_STREAM_IDS = ImmutableSet.of(DEFAULT_EVENTS_STREAM_ID, DEFAULT_SYSTEM_EVENTS_STREAM_ID, FAILURES_STREAM_ID, COLLECTOR_LOGS_STREAM_ID);
    /**
     ...
     */
    ImmutableSet<String> ALL_SYSTEM_STREAM_IDS = ImmutableSet.of(DEFAULT_STREAM_ID, DEFAULT_EVENTS_STREAM_ID, DEFAULT_SYSTEM_EVENTS_STREAM_ID, FAILURES_STREAM_ID, COLLECTOR_LOGS_STREAM_ID);
