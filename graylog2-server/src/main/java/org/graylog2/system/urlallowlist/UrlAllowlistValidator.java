...
public class UrlAllowlistValidator {
     ...
     * a system notification is published (unless this is a test notification) and the notification is
     * blocked.
     *
     * @param url the webhook URL to validate
     * @param ctx the event notification context
     * @throws PermanentEventNotificationException if the URL is not allowlisted
     */
