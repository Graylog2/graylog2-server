...
public interface StreamRuleService {
    ...
    String save(StreamRule streamRule);

    void destroy(StreamRule streamRule);

    StreamRule clone(StreamRule streamRule);
}
