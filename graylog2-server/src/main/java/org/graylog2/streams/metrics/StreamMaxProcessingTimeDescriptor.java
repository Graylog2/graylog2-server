...
/**
 * Provides {@code max_processing_time_ms} metrics for streams.
 * Computes the maximum {@code gl2_processing_duration_ms} per stream over the last 15 minutes.
 */
public class StreamMaxProcessingTimeDescriptor implements EntityCachedMetricDescriptor<Double, Double> {

    public static final String FIELD_NAME = "max_processing_time_ms";

    private final MoreSearch moreSearch;
    private final Duration cacheTtl;

    @Inject
    public StreamMaxProcessingTimeDescriptor(MoreSearch moreSearch,
