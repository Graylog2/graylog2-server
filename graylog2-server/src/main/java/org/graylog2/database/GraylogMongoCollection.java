...
public class GraylogMongoCollection<T> implements MongoCollection<T> {
    private final MongoCollection<T> delegate;

    public GraylogMongoCollection(MongoCollection<T> delegate) {
    ...
    public MongoCollection<T> withWriteConcern(@Nonnull WriteConcern writeConcern) {
        return new GraylogMongoCollection<>(delegate.withWriteConcern(writeConcern));
    }
    ...
    @Nonnull
    @Override
    public <TResult> FindIterable<TResult> find(@Nonnull Bson bson, @Nonnull Class<TResult> aClass) {
        return delegate.find(bson, aClass);
    }
    ...
    @Nonnull
    @Override
    public <TResult> AggregateIterable<TResult> aggregate(@Nonnull List<? extends Bson> list, @Nonnull Class<TResult> aClass) {
        return delegate.aggregate(list, aClass);
    }
    ...
    @Nonnull
    @Override
    public InsertOneResult insertOne(@Nonnull T t) {
    ...
    @Nonnull
    @Override
    public UpdateResult replaceOne(@Nonnull Bson bson, @Nonnull T t) {
        return delegate.replaceOne(bson, t);
    }

    @Nonnull
    @Override
    public UpdateResult replaceOne(@Nonnull Bson bson, @Nonnull T t, @Nonnull ReplaceOptions replaceOptions) {
        return delegate.replaceOne(bson, t, replaceOptions);
    }
    ...
    @Nonnull
    @Override
    public UpdateResult updateOne(@Nonnull Bson bson, @Nonnull Bson bson1) {
        return delegate.updateOne(bson, bson1);
    }

    @Nonnull
    @Override
    public UpdateResult updateOne(@Nonnull Bson bson, @Nonnull Bson bson1, @Nonnull UpdateOptions updateOptions) {
    ...
    @Nonnull
    @Override
    public UpdateResult updateMany(@Nonnull Bson bson, @Nonnull Bson bson1) {
        return delegate.updateMany(bson, bson1);
    }

    @Nonnull
    @Override
    public UpdateResult updateMany(@Nonnull Bson bson, @Nonnull Bson bson1, @Nonnull UpdateOptions updateOptions) {
    ...
    @Nullable
    @Override
    public T findOneAndDelete(@Nonnull Bson bson) {
    ...
    @Nullable
    @Override
    public T findOneAndReplace(@Nonnull Bson bson, @Nonnull T t, @Nonnull FindOneAndReplaceOptions findOneAndReplaceOptions) {
        return delegate.findOneAndReplace(bson, t, findOneAndReplaceOptions);
    }
    ...
    @Nullable
    @Override
    public T findOneAndUpdate(@Nonnull Bson bson, @Nonnull Bson bson1) {
        return delegate.findOneAndUpdate(bson, bson1);
    }

    @Nullable
    @Override
    public T findOneAndUpdate(@Nonnull Bson bson, @Nonnull Bson bson1, @Nonnull FindOneAndUpdateOptions findOneAndUpdateOptions) {
    ...
    @Override
    public void dropIndex(@Nonnull String s) {
