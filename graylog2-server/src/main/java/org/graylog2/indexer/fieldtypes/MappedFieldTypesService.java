...
public class MappedFieldTypesService {
    ...
    private Set<MappedFieldTypeDTO> mergeCompoundFieldTypes(java.util.stream.Stream<MappedFieldTypeDTO> stream) {
        return stream.collect(Collectors.groupingBy(MappedFieldTypeDTO::name, Collectors.toSet()))
                ...
                .map(entry -> {
                    ...
                    final Set<String> distinctTypes = distinctSortedTypeNames(fieldTypes);
                    ...
                    final ImmutableSet<String> commonProperties = commonPropertiesOfTypes(fieldTypes);
    ...
    private LinkedHashSet<String> distinctSortedTypeNames(Set<MappedFieldTypeDTO> fieldTypes) {
    ...
    private ImmutableSet<String> commonPropertiesOfTypes(Set<MappedFieldTypeDTO> fieldTypes) {
        return fieldTypes.stream()
