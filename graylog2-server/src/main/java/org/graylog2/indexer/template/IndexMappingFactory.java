...
public class IndexMappingFactory {
    ...
    @Nonnull
    public IndexMappingTemplate createIndexMapping(@Nonnull IndexTemplateConfig templateConfig) throws IgnoreIndexTemplate {
