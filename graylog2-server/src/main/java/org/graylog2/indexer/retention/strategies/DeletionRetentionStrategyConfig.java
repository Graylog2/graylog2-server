...
public abstract class DeletionRetentionStrategyConfig implements RetentionStrategyConfig {
    ...
    public ValidationResult validate(ElasticsearchConfiguration elasticsearchConfiguration) {
        ...
        if (disabledRetentionStrategies.contains(DeletionRetentionStrategy.NAME)) {
            validationResult.addError(RetentionStrategyConfig.FIELD_NAME, "Deletion retention strategy is deactivated");
        }
