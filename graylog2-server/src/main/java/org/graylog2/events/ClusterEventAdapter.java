...
@Singleton
public class ClusterEventAdapter {
    private static final Logger LOG = LoggerFactory.getLogger(ClusterEventAdapter.class);
    ...
    @Inject
    public ClusterEventAdapter(final MongoJackObjectMapperProvider mapperProvider,
    ...
    private ClusterEventAdapter(final JacksonDBCollection<ClusterEvent, String> dbCollection,
                                final NodeId nodeId,
