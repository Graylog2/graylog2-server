...
public class Configuration extends CaConfiguration {
    ...
    /**
     * Returns the original configured output batch size which is specified as either a count or a byte size value.
     * Prefer using {@link Configuration#getOutputBatchSizeAsBytes()} or
     * {@link Configuration#getOutputBatchSizeAsCount()} instead.
     */
