...
public class DashboardsMetricsSupplier implements TelemetryMetricSupplier {
    private final DashboardService dashboardService;

    @Inject
    public DashboardsMetricsSupplier(DashboardService dashboardsService) {
        this.dashboardService = dashboardsService;
    }
