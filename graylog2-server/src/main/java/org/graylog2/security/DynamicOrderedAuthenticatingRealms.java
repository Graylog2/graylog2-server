 ...
 */
public class DynamicOrderedAuthenticatingRealms extends AbstractCollection<Realm> implements OrderedAuthenticatingRealms {
    ...
    @Inject
    public DynamicOrderedAuthenticatingRealms(Map<String, AuthenticatingRealm> realms,
