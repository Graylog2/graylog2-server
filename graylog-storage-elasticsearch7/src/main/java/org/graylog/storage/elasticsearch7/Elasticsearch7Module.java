...
import org.graylog.storage.elasticsearch7.fieldtypes.streams.AggregationBasedFieldTypeFilterES7;
import org.graylog.storage.elasticsearch7.fieldtypes.streams.CountExistingBasedFieldTypeFilterES7;
...
public class Elasticsearch7Module extends VersionAwareModule {
    ...
    protected void configure() {
        bindForSupportedVersion(AggregationBasedFieldTypeFilterAdapter.class).to(AggregationBasedFieldTypeFilterES7.class);
        bindForSupportedVersion(CountExistingBasedFieldTypeFilterAdapter.class).to(CountExistingBasedFieldTypeFilterES7.class);
