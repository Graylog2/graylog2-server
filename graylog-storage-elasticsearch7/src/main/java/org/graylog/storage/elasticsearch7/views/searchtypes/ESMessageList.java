...
public class ESMessageList implements ESSearchTypeHandler<MessageList> {
    ...
    @WithSpan
    @Override
    public SearchType.Result doExtractResult(Query query, MessageList searchType, org.graylog.shaded.elasticsearch7.org.elasticsearch.action.search.SearchResponse result, ESGeneratedQueryContext queryContext) {
